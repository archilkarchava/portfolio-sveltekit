...
export async function getPinnedRepositories(
  ...
  return githubClient.query<PinnedRepositoriesQuery>(GET_PINNED_REPOSITORIES_QUERY, {login: githubLogin, amount}).toPromise()
}
...
export async function getProfileInfo(
  ...
  return githubClient.query<ProfileInfoQuery>(GET_PROFILE_INFO_QUERY, {login: githubLogin}).toPromise()
}
